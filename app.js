...
.group{border:1px solid var(--ink); padding:10px; background:#fff}
...
.item{display:flex; align-items:center; gap:10px; position:relative}
...
.item [data-tip]::after{
  ...
  padding:8px 10px; width:380px; max-width:60vw; line-height:1.4; font-size:12px;
...
@media (max-width: 1400px){
  ...
  .colpanel{grid-template-columns:repeat(2, minmax(300px, 1fr))}
}
